...
contract("auction NFT functionality", async accounts => {
    ...
    it("start auction with start day now for tokens", async () => {
        ...
        console.log("start auction func", lotId);
        ...
        // console.log(lotStartDate);
        // console.log(lotEndDate);
    ...
    //     await expectRevert(
    //     await Auction.startAuction(lotId, lotStartDate, lotEndDate, step, ERC20Address, tokenAmount, { from: accountOne }),
    //     "revert"
    //     )
    // });
    ...
    //     let lotId = accOneLotsIds[0];
    //     console.log("make bid func", lotId);
